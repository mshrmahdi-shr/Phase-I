...
2. Press **Export PDF**, then check the required ready A–E/H rows. The PDF and CAD actions share this one ordered selection; blocked rows remain visible with correction instructions.
