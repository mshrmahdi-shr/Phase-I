...
test('app wires the current historical provider registry and asset store into PDF planning',()=>{
  ...
  assert.match(source,/const HISTORICAL_PROVIDERS=Object\.freeze\(\[ONTARIO_IMAGERY_PROVIDER,TORONTO_IMAGERY_PROVIDER,OTTAWA_IMAGERY_PROVIDER,NAPL_IMAGERY_PROVIDER,ESRI_WAYBACK_PROVIDER\]\)/);
