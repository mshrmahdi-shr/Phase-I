export function createPrintSession({document,map,validate,fit,render,waitForTiles,onRestore}){
  ...
  async function open(){
    ...
    try{
      ...
      if(legend&&legend.scrollHeight>legend.clientHeight+2)throw new Error('The legend does not fit this sheet. Choose a smaller extent or a dataset with fewer units.');
